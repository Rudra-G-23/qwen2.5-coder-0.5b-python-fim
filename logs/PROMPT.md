Now the end to end process is working. It create a model and also store in hugging face.
...
Now you do these things
- First add a new notebook where weight and bias library install & and used
- Update whole codebase, and tell me in kaggle notebook how to used.
- Make sure, exiting codebase is working.
